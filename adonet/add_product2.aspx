...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection
              (@"data source=(localdb)\MsSqlLocalDb;integrated security=true;initial catalog=msdb"))
        {
            SqlDataAdapter da = new SqlDataAdapter("select * from categories order by catdesc", con);
            DataSet ds = new DataSet();
            da.Fill(ds, "categories");
            ddlCategory.DataSource = ds.Tables["categories"];
...
<body>
  <form id="form1" runat="server">
      ...
      <p></p>
      Select Category: <br />
      <asp:DropDownList ID="ddlCategory" DataTextField="catdesc"  DataValueField="catcode"  runat="server"></asp:DropDownList>
      <p /> 
